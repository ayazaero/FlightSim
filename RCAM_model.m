...
Xeng1 = 0;                      %x position of engine 1 force in Fm (m)
Yeng1 = -7.94;                  %y position of engine 1 force in Fm (m)
Zeng1 = -1.9;                   %z position of engine 1 force in Fm (m)

Xeng2 = 0;                      %x position of engine 2 force in Fm (m)
Yeng2 = 7.94;                   %y position of engine 2 force in Fm (m)
Zeng2 = -1.9;                   %z position of engine 2 force in Fm (m)
...
alpha_t = alpha - epsilon + u2 + 1.3*x5*lt/Vair;
...
MEcg1_b = cross(Meng1,FE1_b);
MEcg2_b = cross(Meng2,FE2_b);
